        ...
        <div class="row">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">入职时间区</label>
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_start" name="start" readonly="readonly" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间"id="txt_search_end" name="stop" readonly="readonly" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
					...
					<form id="form_user" method="post" action="reserveUser.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员特点：</td>
								<td>
									<input type="checkbox" id="expressTrait" name="expressTrait" value="勤劳" aria-required="true" required/>勤劳
