	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    		var mms = echarts.init(document.getElementById("main1"));
    			...
    			$.ajax({
    			    ...
    			    success:function(res){
    			    	var xdata = new Array();
    			    	var ydata = new Array();
    			    	res.coulist.forEach(function(c){
    			    		xdata.push(c.cname);
    			    		ydata.push({value:c.num,name:c.cname});
    			    	});
    			    	if(res.success){
    			    		option = {
    			    			    title: {
