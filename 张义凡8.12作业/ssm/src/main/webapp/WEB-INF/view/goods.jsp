...
<body class="gray-bg">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_goods" role="dialog" aria-labelledby="modal_user_goods" aria-hidden="true">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_add").click(function(){
	    		...
	    		$('#modal_user_goods').modal({backdrop: 'static', keyboard: false});
				$('#modal_user_goods').modal('show');
	        });
